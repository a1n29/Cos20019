...
define('STUDENT_NAME', 'Tran Hoang Hai Anh');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '104177513');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Saturday 13:00');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'atranbucket');
...
define('DB_ENDPOINT', 'assignment2db.c6wi8l7att9r.us-east-1.rds.amazonaws.com');
